public class MachineGame {
    ...
    public MachineGame(double aposta) {
        this.aposta = aposta;
    }
    ...
    // Add to Machine.java
    public void runMachine(int userId, int machineId) {
        rolo1 = new Rolo();
        rolo2 = new Rolo();
        rolo3 = new Rolo();
        ...
        // ✅ Add machine and user info here
        System.out.printf("\n -> Resultado final (Máquina %d, Usuário %d): %s\n",
                machineId, userId, getResultado());
